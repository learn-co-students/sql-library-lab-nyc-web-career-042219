...
def select_value_and_count_of_most_prolific_species
  ...
  COUNT(characters.species) FROM characters GROUP BY characters.species
...
def select_series_title_with_most_human_characters
  ...
  ON series.author_id = characters.author_id GROUP BY series.title HAVING COUNT(characters.species)
