...
INSERT INTO characters (id, name, motto, species, author_id, series_id) VALUES (5, "Number Six", "They can be good.", "cylon", 2, 2), (6, "Adama", "So say we all", "human", 2, 2), (7, "Chief", "frak it", "cylon", 2, 2), (8, "Boomer", "boom!", "cylon", 2, 2);
