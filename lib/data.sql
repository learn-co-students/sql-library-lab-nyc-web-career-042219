...
INSERT INTO characters (id, name, motto, species, author_id, series_id) VALUES (5, "Character One", "They can be good.", "cylon", 2, 2), (6, "Character Two", "So say we all", "human", 2, 2), (7, "Character Three", "frak it", "cylon", 2, 2), (8, "Character Four", "boom!", "cylon", 2, 2);
